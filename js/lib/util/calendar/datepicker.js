...
define(function(require) {
			...
			var ids = {},
				tpl = {
					...
					months: [
						...
						'<tr>',
						'<td><a href="#"><span><%=data[0]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[1]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[2]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[3]%></span></a></td>',
						'</tr>',
						'<tr>',
						'<td><a href="#"><span><%=data[4]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[5]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[6]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[7]%></span></a></td>',
						'</tr>',
						'<tr>',
						'<td><a href="#"><span><%=data[8]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[9]%></span></a></td>',
						'<td class="_cc"></td>',
						'<td><a href="#"><span><%=data[10]%></span></a></td>',
						'<td class="_cc"></td>',
	...
	require("../../../res/css/datepicker.css");
});